...
import { Button, ButtonTypeEnum, Socials } from '@/app/components/shared';
...
export const Header = () => {
  ...
  return (
    <>
      <div
        className="
          hidden w-full items-center justify-between gap-4 bg-[var(--green-100)] px-4 py-3 font-medium
          md:px-6 md:py-4 lg:flex lg:px-[52px] lg:py-[15px]
        "
      >
