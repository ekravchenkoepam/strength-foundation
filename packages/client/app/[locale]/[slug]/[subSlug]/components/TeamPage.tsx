  ...
  return (
    <>
      ...
      ">
        <div className="flex justify-center gap-[32px] relative max-w-[1200px] w-full">
          ...
          <div className="absolute -bottom-[80px] right-0">
            <button
              className="flex items-center gap-2 text-white hover:underline transition-colors text-[16px]"
            >
              <div className="text-[16px]">Переглянути усіх членів команди</div>
              <Image
                src="/images/pointer-right.svg"
                alt="arrow"
                width={20}
                height={20}
                className="invert"
      ...
      <div className="w-full bg-white text-center py-[120px] px-4">
        ...
        <button
          className="bg-[#F2C94C] hover:bg-[#e6ba42] transition-colors text-black font-semibold py-4 px-10 rounded-[12px]"
        >
