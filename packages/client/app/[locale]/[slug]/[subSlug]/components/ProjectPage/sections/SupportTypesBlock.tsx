...
export const SupportTypesBlock = ({ title, items = [] }: SupportTypesBlockProps) => (
  <section className="relative left-1/2 right-1/2 -mx-[50vw] w-screen bg-[var(--green-100)] bg-[url('/images/asphalt-bg-alt.png')] bg-cover bg-center px-[52px] pt-[100px] pb-[80px] md:pb-[100px]">
